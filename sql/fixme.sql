...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2022 at 02:51 PM
...
(100012, 1, 3007, 1350, 1, 'Waiting for Dispatch', 'Warehouse', '2022-09-15'),
(100013, 1, 3007, 1350, 1, 'Canceled', 'Warehouse', '2022-09-15'),
(100014, 17, 3002, 1385, 1, 'Shipping', 'Warehouse', '2022-09-15'),
(100015, 17, 3001, 1400, 1, 'Waiting for Dispatch', 'Warehouse', '2022-09-15'),
(100016, 1, 3003, 750, 1, 'Waiting for Dispatch', 'Warehouse', '2022-09-15');
...
(3007, 1000, 'part', 'Galaxy S20 Rear  Panel', 'Replace a rear panel in your Samsung Galaxy S20 smartphones.\r\n\r\nFix issues like a broken or scratched rear cover.', 'images\\parts\\samsungs20back.png', 1500, 1350, 10, 3, 6, 5, 0),
...
--
ALTER TABLE `porder`
  MODIFY `oid` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100017;
